package com.ecommerce.platform.iam.interfaces.rest;

import com.ecommerce.platform.iam.domain.model.queries.GetAllRolesQuery;
import com.ecommerce.platform.iam.domain.services.RoleQueryService;
import com.ecommerce.platform.iam.interfaces.rest.resources.RoleResource;
import com.ecommerce.platform.iam.interfaces.rest.transform.RoleResourceFromEntityAssembler;
